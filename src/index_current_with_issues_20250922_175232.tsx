  ...
  return c.html(`
    ...
    <body class="min-h-screen">
        ...
        <script>
            ...
            // (Se eliminó la primera función loadDailyHistory para evitar conflictos)
            ...
            async function loadDailyHistory() {
                try {
                    ...
                    // DEBUG ESPECÍFICO DEL 21 DE SEPTIEMBRE
                    const sept21Data = snapshots.find(s => s.snapshot_date === '2025-09-21');
                    if (sept21Data) {
                        console.log('🎯 ENCONTRADO DATOS DEL 21 SEPT:', sept21Data);
                        console.log('   📅 Fecha:', sept21Data.snapshot_date);
                        console.log('   💰 Precio:', sept21Data.price_per_unit);
                        console.log('   📊 Valor:', sept21Data.total_value);
                    } else {
                        console.log('❌ NO SE ENCONTRARON DATOS DEL 21 SEPT');
                    }
