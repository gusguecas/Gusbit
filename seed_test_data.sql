...
INSERT OR REPLACE INTO transactions (asset_symbol, transaction_type, quantity, price_per_unit, transaction_date, created_at) VALUES
  ('BTC', 'buy', 0.5, 60000.00, '2024-09-15 10:00:00', datetime('now')),
  ('ETH', 'buy', 5.0, 2400.00, '2024-09-16 11:00:00', datetime('now')),
  ('AAPL', 'buy', 10.0, 150.00, '2024-09-17 12:00:00', datetime('now'));

-- Insertar holdings actuales
INSERT OR REPLACE INTO holdings (asset_symbol, quantity, avg_cost, total_cost, current_price, updated_at) VALUES
  ('BTC', 0.5, 60000.00, 30000.00, 115715.52, datetime('now')),
  ('ETH', 5.0, 2400.00, 12000.00, 2420.00, datetime('now')),
  ('AAPL', 10.0, 150.00, 1500.00, 155.00, datetime('now'));

-- Insertar snapshots diarios críticos (Sep 20 y 21)
INSERT OR REPLACE INTO daily_snapshots (asset_symbol, snapshot_date, quantity, price_per_unit, total_value, created_at) VALUES
  -- September 20, 2024 - ETH con precio correcto
  ...
  -- September 21, 2024 - Todos con precios correctos
